...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 27 May 2024, 20:08:06
...
CREATE TABLE `tarifler` (
  ...
  `tarih` text NOT NULL DEFAULT '27.05.2024',
...
(14, 'Ekmek & Hamur İşleri', 'ekmek-ve-hamur-isleri', 'Kaşarlı Tavuklu Pide Lezzeti: Ev Mutfağında Yaratıcı Dokunuşlar!', '30 DakikaA', 'Kişilik', '2500 Kalori5 ', 'uploads/pide.jpg', 'kasarli-tavuklu-pide', '', '<p>Mantının hamuru i&ccedil;in un hari&ccedil; diğer malzemeleri yoğurma kabına alıp karıştırın., Yavaş yavaş unu ekleyerek ele yapışmayan sert bir hamur elde edene kadar yoğurun., Hamurdan dilediğiniz b&uuml;y&uuml;kl&uuml;kte bezeler yapıp &uuml;zerini nemli bir bezle kapatın., İ&ccedil; harcı i&ccedil;in soğanı rendeleyip kıyma ve baharatlarıyla birlikte yoğurun., Bezeleri oklava yardımıyla ince a&ccedil;ıp &ccedil;ay bardağı yardımıyla yuvarlak kalıp &ccedil;ıkarın., &Uuml;zerine i&ccedil; harcından koyup resimlerdeki gibi &ouml;nce yarım daire şeklinde katlayıp kenarlarını iyice kapatıp daha sonra iki ucunu birleştirin., Artan hamurları tekrar beze yapıp aynı işlemi tekrarlayın., Hazırladığınız mantıları bol kızgın yağda pişirin., Fazlalık yağını alması i&ccedil;in &ouml;nce kağıt havlu serili bir tabağa, daha sonra da servis tabağına alın., Sal&ccedil;alı sos i&ccedil;in tereyağını eritip nane ve sal&ccedil;ayı kavurun., &Uuml;zerine yarım &ccedil;ay bardağı kadar sıcak su d&ouml;k&uuml;p karıştırın., Mantının &uuml;zerine &ouml;nce sarımsaklı yoğurt, daha sonra da sal&ccedil;alı sostan gezdirin.</p>\r\n', '12.12.2023', 93, 2),
(51, 'Ekmek & Hamur İşleri', '', 'Kaşarlı Tavuklu Pide Lezzeti: Ev Mutfağında Yaratıcı Dokunuşlar', ' 30 Dakika', ' 5 Kişilik', ' 2500 Kalori', 'uploads/pide.jpg', 'kasarli-tavuklu-pide-lezzeti:-ev-mutfaginda-yaratici-dokunuslar', '', '<p>wefwetwertwetwertwetr</p>\r\n', '27.05.2024', 0, 0),
(52, 'Tatlılar & Kurabiyeler', '', 'Kaşarlı Tavuklu Pide Lezzeti: Ev Mutfağında Yaratıcı Dokunuşlar', ' 30 Dakika', ' 5 Kişilik', ' 2500 Kalori', 'uploads/pide.jpg', 'kasarli-tavuklu-pide-lezzeti:-ev-mutfaginda-yaratici-dokunuslar', '2,3,7', '<p>dasdasfdasf</p>\r\n', '27.05.2024', 0, 0);
...
--
ALTER TABLE `tarifler`
  MODIFY `tarif_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
